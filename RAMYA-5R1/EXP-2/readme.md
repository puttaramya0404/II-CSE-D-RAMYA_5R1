...
# 2.29) Find the age of the youngest sailor who is eligible to vote (i.e., is at least 18 years old) for each rating level with at least two such sailors.
```
...
# 2.33) Find the average age of sailors who are of voting age (i.e., at least 18 years old) for each r>
```
SELECT S.rating, AVG(S.age)
FROM Sailors S
WHERE S.age >= 18
